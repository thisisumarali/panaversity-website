    ...
    < footer className="bg-white" >
      <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
        <div className="max-w-md">
          <h2 className="bg-clip-text text-4xl font-bold  text-transparent bg-gradient-to-r from-neutral-900 to-purple-900 bg-opacity-100">
            Panversity
          </h2>
          ...
          <form className="mt-6">
            <div className="relative max-w-lg">
              ...
              <button
                className="absolute end-1 top-1/2 -translate-y-1/2 rounded-full bg-purple-600 px-5 py-3 text-sm font-medium text-white transition hover:bg-purple-700"
              >
                Subscribe
              </button>
            </div>
